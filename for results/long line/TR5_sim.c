...
int main() {
    ...
    mna_set_integration_method(&solver, MNA_INTEGRATION_BDF2);
    ...
    double R_total_line1 = 0.0001 * length_line1 / 1000.0;
    ...
    if (status != MNA_SUCCESS) {
        fprintf(stderr, "DC Solve Failed\n");
    ...
    mna_set_integration_method(&solver, MNA_INTEGRATION_TR);
