...
MNAStatus mna_init_sized(MNASolver* solver, int max_nodes, int max_sources, int max_components) {
    ...
    solver->A = calloc(matrix_elems, sizeof(double));
    solver->b = calloc(solver->matrix_size, sizeof(double));
    solver->x = calloc(solver->matrix_size, sizeof(double));
    solver->ac_solution = calloc(solver->matrix_size, sizeof(double complex));
...
void mna_reset_system(MNASolver* solver) {
    size_t matrix_elems = solver->matrix_size * solver->matrix_size;
    memset(solver->A, 0, matrix_elems * sizeof(double));
    memset(solver->b, 0, solver->matrix_size * sizeof(double));
    memset(solver->x, 0, solver->matrix_size * sizeof(double));
}
...
MNAStatus mna_solve_dc(MNASolver* solver) {
    ...
    double* orig_source_values = (double*)malloc(solver->num_components * sizeof(double));
...
MNAStatus mna_solve_ac(MNASolver* solver, double frequency) {
    ...
    double complex (*A_complex)[matrix_size] = calloc(matrix_size * matrix_size, sizeof(double complex));
    double complex *b_complex = calloc(matrix_size, sizeof(double complex));
    double complex *x_complex = calloc(matrix_size, sizeof(double complex));
